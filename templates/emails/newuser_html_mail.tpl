...
<p>Úspešne ste sa zaregistrovali do aplikácie <strong>Abstrakter</strong>, táto aplikácia umožňuje registráciu, správu a odovzdávanie abstraktov na vybranú vzdelávaciu aktivitu webu {$smarty.session.abstrakter.my_server_name}.</p>
<p>
